...
## Graphics
* [Acorn](http://www.flyingmeat.com/acorn/) [HBC] - Amazing image editor
* [Affinity Designer](https://affinity.serif.com/en-us/designer/) [MAS] - Vector image editor
* [Droplr](https://droplr.com/)[HBC] - Easy image sharing - requires subscripion
* [Graphviz](http://www.graphviz.org/) [HBC] - Draw graphs with DOT syntax
* [Google Photos Backup](https://photos.google.com/apps) [HBC] - Uploads all my photos to Google Photos
...
* [Snagit](https://www.techsmith.com/snagit.html) [HBC] - Screen capture tool

## Developer
* [Base](http://menial.co.uk/base/) [HBC] - SQLite GUI
...
* [Paw](https://paw.cloud/) [HBC] - API testing tool
* [Sequel Pro](http://www.sequelpro.com/) [HBC] - MySQL GUI
* [Tower](http://www.git-tower.com/) [HBC] - Git GUI
* [Transmit](http://panic.com/transmit/) [HBC] - FTP
* [Xcode](https://developer.apple.com/xcode/) [MAS] - Mac/iOS IDE

### Virtual Machines
* [Vagrant](http://www.vagrantup.com/) [HBC] - Virtual machine management for development
    - [Vagrant Manager](http://vagrantmanager.com/) [HBC]
* [VirtualBox](https://www.virtualbox.org/) [HBC] - Free virtual machine software - good for Vagrant
...
* [PDFpenPro](http://www.smilesoftware.com/PDFpenPro/) [HBC] - PDF editor
* [Reeder](http://reederapp.com/mac/) [MAS] - RSS reader
* [Soulver](http://www.acqualia.com/soulver/) [HBC] - Better calculator
...
## Utilities
* [Aerial](https://github.com/JohnCoates/Aerial) [HBC] - Sceensavers
* [Alfred](http://www.alfredapp.com/) (and the [Powerpack](http://www.alfredapp.com/powerpack/)) [HBC] - App launcher and general utility
...
* [Fluid](http://fluidapp.com/) [HBC] - Wrap webpages as standalone applications
...
* [Mountain](http://appgineers.de/mountain/) [HBC] - Mount and unmount external drives
* [PowerMate Manager](https://support.griffintechnology.com/product/powermate/) [HBC] for the [Griffin PowerMate](https://griffintechnology.com/us/device/laptops/powermate)
...
- [Open in Marked](https://plugins.jetbrains.com/plugin/7307-open-in-marked)
...
- [PHPUnit code coverage](https://plugins.jetbrains.com/plugin/6167-phpunit-code-coverage)
