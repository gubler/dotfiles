...
cp -r ${HOME}/.dotfiles/reference/SublimeText/Marked 2.sublime-build ~/Library/Application\ Support/Sublime\ Text*/Packages/User/Marked 2.sublime-build 2> /dev/null
